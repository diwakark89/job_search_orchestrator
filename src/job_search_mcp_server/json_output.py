...
from job_search_mcp_server.job_search_scrapers.model import normalize_description_source
...
def build_jobs_json_payload(jobs_df: pd.DataFrame, scraped_at: datetime | None = None) -> list[NormalizedJob]:
    """Convert a Job Search DataFrame into the strict normalized JSON schema."""
