#!/usr/bin/env python3
"""
Standalone CLI for Job Search job search.
...
def main() -> None:
    ...
    if jobs_df is None:
        _print_error_envelope("runtime_error", "Job search failed: no results returned")
        return
    ...
    jobs_list = [dict(job) for job in build_jobs_json_payload(jobs_df)]
