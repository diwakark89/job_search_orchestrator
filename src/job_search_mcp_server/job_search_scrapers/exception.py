"""
job_search.jobboard.exceptions
~~~~~~~~~~~~~~~~~~~
...
class BerlinStartupJobsException(Exception):
    def __init__(self, message=None):
        super().__init__(message or "An error occurred with Berlin Startup Jobs")


class WelcomeToTheJungleException(Exception):
    def __init__(self, message=None):
        super().__init__(message or "An error occurred with Welcome to the Jungle")


class EuStartupsException(Exception):
    def __init__(self, message=None):
        super().__init__(message or "An error occurred with EU-Startups")


class JoinException(Exception):
    def __init__(self, message=None):
        super().__init__(message or "An error occurred with join.com")