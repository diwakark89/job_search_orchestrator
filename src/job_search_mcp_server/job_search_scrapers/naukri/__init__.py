...
from job_search_mcp_server.job_search_scrapers.exception import NaukriException
from job_search_mcp_server.job_search_scrapers.naukri.constant import headers as naukri_headers
from job_search_mcp_server.job_search_scrapers.naukri.util import (
    is_job_remote,
    parse_job_type,
...
class Naukri(Scraper):
    ...
    def _process_job(
        ...
        description_source = "detail_page" if full_descr and description else None
