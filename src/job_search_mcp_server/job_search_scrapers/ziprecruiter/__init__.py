...
from job_search_mcp_server.job_search_scrapers.ziprecruiter.constant import headers, get_cookie_data
...
from job_search_mcp_server.job_search_scrapers.ziprecruiter.util import get_job_type_enum, add_params
...
class ZipRecruiter(Scraper):
    ...
    def _process_job(self, job: dict) -> JobPost | None:
        ...
        description_source = "detail_page" if description_full else ("listing_api" if description else None)
