from job_search_mcp_server.job_search_scrapers.model import CompensationInterval, JobType, Compensation
from job_search_mcp_server.job_search_scrapers.util import get_enum_from_job_type
